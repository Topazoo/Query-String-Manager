...
class TestGenerateBase64QueryString(unittest.TestCase):
    """
        Tests for :class:`QueryStringParser.generate_base64_encoded_query_string()`
    """
    ...
    def test_throws_exception_on_invalid_dict(self):
        ...
        for test_dict in TEST_INVALID_DICTS:
            self.assertRaises(ValueError, lambda: QueryStringParser.generate_base64_encoded_query_string(test_dict))
